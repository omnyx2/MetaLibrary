import styles from './jumpingbooks.module.css';

export default function BookShelf({mode = "hover"}) {
  return (
    <svg className={styles["bookShelf_"+mode]} xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 84 94" height="94" width="84">
      ...
      <g className={`${styles.bookShelf__book} ${styles.bookShelf__bookOne}`} fillRule="evenodd">
      ...
      <g className={`${styles.bookShelf__book} ${styles.bookShelf__bookTwo}`} fillRule="evenodd">
      ...
      <g className={`${styles.bookShelf__book} ${styles.bookShelf__bookThree}`} fillRule="evenodd">
      ...
      <g fillRule="evenodd">
        <path className={styles.bookShelf__shelf} fill="#ae8280" d="M21 60h40c1.105 0 2 .895 2 2s-.895 2-2 2H21c-1.105 0-2-.895-2-2s.895-2 2-2z"/>
