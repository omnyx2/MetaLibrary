...
const ConfigSelector = ({ label, curList, curItem, setCurItem }) => {
  ...
  return (
    <div className="relative w-0 h-0">
      ...
      <select
        className="absolute w-8 h-8 left-4 top-8 rounded-full bg-white-800 text-black cursor-pointer transition duration-300 ease-in-out transition-all hover:w-60 hover:bg-black-600"
